...
2. Set up your routing with React Router. Render dummy components and make sure they are rendering in the right place. We have already included one route which renders an ArticleList component and displays all the articles available.
